...
$navClass=function(string $section)use($navActive):string{return 'whitespace-nowrap rounded-xl px-3 py-2 transition '.($navActive($section)?'bg-zinc-800 font-bold text-white ring-1 ring-emerald-700/70':'text-zinc-400 hover:bg-zinc-900 hover:text-white');};
...
<body class="min-h-screen">
  <header class="sticky top-0 z-40 border-b border-zinc-800 bg-zinc-950/95 backdrop-blur">
    <div class="mx-auto flex max-w-6xl flex-wrap items-center gap-3 px-4 py-3">
      ...
      <nav class="top-nav order-3 flex w-full items-center gap-1 overflow-x-auto text-sm text-zinc-400 sm:order-none sm:w-auto">
