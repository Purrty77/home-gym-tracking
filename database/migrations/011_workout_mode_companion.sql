...
ALTER TABLE workout_sessions
  ADD COLUMN template_order_changed BOOLEAN NOT NULL DEFAULT FALSE AFTER rest_paused_seconds,
  ADD COLUMN template_sets_changed BOOLEAN NOT NULL DEFAULT FALSE AFTER template_order_changed;

ALTER TABLE workout_exercises
  ADD COLUMN warmup_decision ENUM('pending','added','skipped') NOT NULL DEFAULT 'skipped' AFTER planned_rest_seconds;
