...
CREATE TABLE exercises (
    ...
    external_dataset_id VARCHAR(20) NULL,
    canonical_name VARCHAR(180) NULL,
    dataset_category VARCHAR(100) NULL,
    body_part VARCHAR(100) NULL,
    dataset_equipment VARCHAR(100) NULL,
    target_muscle VARCHAR(150) NULL,
    dataset_muscle_group VARCHAR(150) NULL,
    secondary_muscles JSON NULL,
    instructions TEXT NULL,
    instruction_steps JSON NULL,
    image_path VARCHAR(255) NULL,
    gif_path VARCHAR(255) NULL,
    media_attribution VARCHAR(255) NULL,
    ...
    UNIQUE KEY uq_exercises_dataset_source_id (source,external_dataset_id),
