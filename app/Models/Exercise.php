...
final class Exercise
{
    ...
    {
        $sql = "SELECT ws.id session_id,ws.performed_at,es.position,es.set_type,es.weight_kg,es.repetitions,es.rest_seconds,es.notes,es.completed FROM exercise_sets es JOIN workout_exercises we ON we.id=es.workout_exercise_id JOIN workout_sessions ws ON ws.id=we.workout_session_id WHERE we.exercise_id=?";
        $params = [$id];
