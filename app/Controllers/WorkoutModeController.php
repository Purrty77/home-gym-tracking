...
final class WorkoutModeController extends Controller
{
    ...
    public function removeSet(): void { header('Content-Type: application/json');try{echo json_encode($this->service->removeSet((int)($_POST['set_id']??0),($_POST['confirmed']??'0')==='1'),JSON_THROW_ON_ERROR);}catch(RuntimeException $e){http_response_code(422);echo json_encode(['error'=>$e->getMessage()]);} }
